-- Vendor Scorecard v2: Pull data from GRNs (raw material), DCs (job work out), and job_card_steps (legacy)
...
SELECT
  ...
  CASE
    ...
    THEN 'new'
    WHEN
      -- Any source exceeds 5% rejection
      GREATEST(
