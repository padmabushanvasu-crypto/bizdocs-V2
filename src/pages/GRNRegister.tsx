  ...
  return (
    <div className="p-4 md:p-6 space-y-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <MetricCard title="Items Accepted" value={formatNumber(stats?.totalAccepted ?? 0)} icon={Package} />
        <MetricCard title="Non-Conforming Items" value={formatNumber(stats?.totalRejected ?? 0)} icon={AlertTriangle} className={stats?.totalRejected ? "border-destructive/30" : ""} />
