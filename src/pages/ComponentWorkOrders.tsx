          ...
          <table className="w-full border-collapse text-sm">
            <thead className="sticky top-0 z-10">
              <tr>
                ...
                <th className="px-3 py-2 text-xs font-semibold text-slate-500 uppercase tracking-wide bg-slate-50 border-b border-slate-200 text-left hidden md:table-cell">Raised By</th>
                ...
                <th className="px-3 py-2 text-xs font-semibold text-slate-500 uppercase tracking-wide bg-slate-50 border-b border-slate-200 text-right hidden md:table-cell">Days Open</th>
              ...
              {isLoading ? (
                ...
                filtered.map((awo: AssemblyWorkOrder) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-2 text-sm text-slate-700 border-b border-slate-100 text-left hidden md:table-cell">{awo.raised_by ?? "—"}</td>
                    ...
                    <td className="px-3 py-2 text-sm text-slate-700 border-b border-slate-100 text-right tabular-nums font-mono text-slate-500 hidden md:table-cell">
