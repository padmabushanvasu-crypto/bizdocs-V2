...
**Status:** Phases 0, 1, 2 complete and live. Phase 3a (forward-path UI) built and pushed, pending one live click-through and PR merge. Phase 3b (backward-path UI) and Phase 4 not started. **Canonical location: `docs/DC_STAGE_FLOW_REDESIGN.md` in the repo** — this file was previously only ever kept outside the repo, which caused Claude Code to correctly stop and report it missing on 5 Sep 2026; it has since been committed and should be read from there going forward, not regenerated.
